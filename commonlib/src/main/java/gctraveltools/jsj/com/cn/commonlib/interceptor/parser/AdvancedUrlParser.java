 ...
 */
package gctraveltools.jsj.com.cn.commonlib.interceptor.parser;
...
import gctraveltools.jsj.com.cn.commonlib.interceptor.cache.Cache;
import gctraveltools.jsj.com.cn.commonlib.interceptor.cache.LruCache;
 ...
 * 您调用 {@link ChangeUrlInterceptor#putDomain(String, String)}方法传入的 URL 地址是 https://www.google.com/api
 * 经过本解析器解析后生成的新 URL 地址为 http://www.google.com/api/part
 * <p>
 * 2.
 * 旧 URL 地址为 https://www.github.com/wiki/part, 其中 BaseUrl 为 https://www.github.com/wiki
 * 您调用 {@link ChangeUrlInterceptor#putDomain(String, String)}方法传入的 URL 地址是 https://www.google.com
...
public class AdvancedUrlParser implements UrlParser {
    private ChangeUrlInterceptor mRetrofitUrlManager;
    private Cache<String, String> mCache;

    @Override
    public void init(ChangeUrlInterceptor retrofitUrlManager) {
