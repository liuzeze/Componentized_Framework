...
public final class BaseRequest extends
  ...
  public BaseRequest clear() {
    appVersion = "";
    sourceWay = gctraveltools.jsj.com.cn.servers1.bean.nano.SourceWay.SourceWayNoSetting;
    languageVersion = gctraveltools.jsj.com.cn.servers1.bean.nano.LanguageVersion.CN;
    terminalExt = "";
    registrationId = "";
    iMEI = "";
    opEmployeeID = 0;
    token = "";
    dataCommission = gctraveltools.jsj.com.cn.servers1.bean.nano.DataCommission.DataCommissionNoSetting;
    deptID = 0;
    sourceCompanyID = 0;
    actID = "";
    jSJID = "";
  ...
  public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
    ...
    if (this.sourceWay != gctraveltools.jsj.com.cn.servers1.bean.nano.SourceWay.SourceWayNoSetting) {
      output.writeInt32(2, this.sourceWay);
    }
    if (this.languageVersion != gctraveltools.jsj.com.cn.servers1.bean.nano.LanguageVersion.CN) {
    ...
    if (this.dataCommission != gctraveltools.jsj.com.cn.servers1.bean.nano.DataCommission.DataCommissionNoSetting) {
    ...
    while (true) {
      ...
      switch (tag) {
        ...
        case 16: {
          ...
          switch (value) {
            case gctraveltools.jsj.com.cn.servers1.bean.nano.SourceWay.SourceWayNoSetting:
            case gctraveltools.jsj.com.cn.servers1.bean.nano.SourceWay.Web:
            case gctraveltools.jsj.com.cn.servers1.bean.nano.SourceWay.Wap:
            case gctraveltools.jsj.com.cn.servers1.bean.nano.SourceWay.IOS:
            case gctraveltools.jsj.com.cn.servers1.bean.nano.SourceWay.Android:
            case gctraveltools.jsj.com.cn.servers1.bean.nano.SourceWay.CRM_p:
            case gctraveltools.jsj.com.cn.servers1.bean.nano.SourceWay.BusinessTravel:
            case gctraveltools.jsj.com.cn.servers1.bean.nano.SourceWay.WeChat:
            case gctraveltools.jsj.com.cn.servers1.bean.nano.SourceWay.WeChatProgram:
        ...
        case 24: {
          int value = input.readInt32();
          switch (value) {
            case gctraveltools.jsj.com.cn.servers1.bean.nano.LanguageVersion.CN:
            case gctraveltools.jsj.com.cn.servers1.bean.nano.LanguageVersion.EN:
        ...
        case 72: {
          int value = input.readInt32();
          switch (value) {
            case gctraveltools.jsj.com.cn.servers1.bean.nano.DataCommission.DataCommissionNoSetting:
            case gctraveltools.jsj.com.cn.servers1.bean.nano.DataCommission.Personal:
            case gctraveltools.jsj.com.cn.servers1.bean.nano.DataCommission.Department:
            case gctraveltools.jsj.com.cn.servers1.bean.nano.DataCommission.DepartmentAndSub:
            case gctraveltools.jsj.com.cn.servers1.bean.nano.DataCommission.All:
