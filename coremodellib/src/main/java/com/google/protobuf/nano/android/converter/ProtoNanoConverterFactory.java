 ...
 */
package com.google.protobuf.nano.android.converter;
 ...
 * subclasses).
 */
public final class ProtoNanoConverterFactory extends Converter.Factory {
    public static ProtoNanoConverterFactory create() {
        return new ProtoNanoConverterFactory();
    }

    private ProtoNanoConverterFactory() { }
    ...
    public Converter<ResponseBody, ?> responseBodyConverter(Type type,
        ...
        return new ProtoNanoResponseBodyConverter<>((Class<? extends MessageNano>) typeClass);
    }
