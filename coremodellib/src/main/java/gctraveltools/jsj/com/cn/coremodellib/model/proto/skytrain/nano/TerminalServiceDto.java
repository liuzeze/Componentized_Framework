...
public final class TerminalServiceDto extends
  ...
  public gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.VVIPHallDto[] vIPHallDtos;

  // repeated .BoardingDto BoardingDtos = 3;
  public gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.BoardingDto[] boardingDtos;

  // repeated .VipChannelDto VipChannelDtos = 4;
  public gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.VipChannelDto[] vipChannelDtos;

  // repeated .VVIPHallDto VVIPHallDtos = 5;
  public gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.VVIPHallDto[] vVIPHallDtos;
  ...
  public TerminalServiceDto clear() {
    airportTerminalName = "";
    vIPHallDtos = gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.VVIPHallDto.emptyArray();
    boardingDtos = gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.BoardingDto.emptyArray();
    vipChannelDtos = gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.VipChannelDto.emptyArray();
    vVIPHallDtos = gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.VVIPHallDto.emptyArray();
  ...
  public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
    ...
    if (this.vIPHallDtos != null && this.vIPHallDtos.length > 0) {
      for (int i = 0; i < this.vIPHallDtos.length; i++) {
        gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.VVIPHallDto element = this.vIPHallDtos[i];
        if (element != null) {
    ...
    if (this.boardingDtos != null && this.boardingDtos.length > 0) {
      for (int i = 0; i < this.boardingDtos.length; i++) {
        gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.BoardingDto element = this.boardingDtos[i];
        if (element != null) {
    ...
    if (this.vipChannelDtos != null && this.vipChannelDtos.length > 0) {
      for (int i = 0; i < this.vipChannelDtos.length; i++) {
        gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.VipChannelDto element = this.vipChannelDtos[i];
        if (element != null) {
    ...
    if (this.vVIPHallDtos != null && this.vVIPHallDtos.length > 0) {
      for (int i = 0; i < this.vVIPHallDtos.length; i++) {
        gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.VVIPHallDto element = this.vVIPHallDtos[i];
        if (element != null) {
    ...
    while (true) {
      ...
      switch (tag) {
        ...
        case 18: {
          ...
          gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.VVIPHallDto[] newArray =
              new gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.VVIPHallDto[i + arrayLength];
          if (i != 0) {
            java.lang.System.arraycopy(this.vIPHallDtos, 0, newArray, 0, i);
          }
          for (; i < newArray.length - 1; i++) {
            newArray[i] = new gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.VVIPHallDto();
        ...
        case 26: {
          ...
          gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.BoardingDto[] newArray =
              new gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.BoardingDto[i + arrayLength];
          if (i != 0) {
            java.lang.System.arraycopy(this.boardingDtos, 0, newArray, 0, i);
          }
          for (; i < newArray.length - 1; i++) {
            newArray[i] = new gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.BoardingDto();
            input.readMessage(newArray[i]);
            input.readTag();
          }
          // Last one without readTag.
        ...
        case 34: {
          ...
          gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.VipChannelDto[] newArray =
              new gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.VipChannelDto[i + arrayLength];
          if (i != 0) {
            java.lang.System.arraycopy(this.vipChannelDtos, 0, newArray, 0, i);
          }
          for (; i < newArray.length - 1; i++) {
            newArray[i] = new gctraveltools.jsj.com.cn.coremodellib.model.proto.skytrain.nano.VipChannelDto();
            input.readMessage(newArray[i]);
            input.readTag();
          }
          // Last one without readTag.
