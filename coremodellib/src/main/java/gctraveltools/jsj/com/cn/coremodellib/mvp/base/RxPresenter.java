...
/**
 * -------- 日期 ---------- 维护人 ------------ 变更内容 --------
 * 2017/12/26	9:24	    刘泽			    新增 类
 * 2017/12/26	9:24	    刘泽			    增加yyy属性
 */

public class RxPresenter<T extends BaseView> extends AndroidViewModel implements BasePresenter<T> {

    protected T mView;
    private CompositeDisposable mCompositeDisposable;
    private ArrayMap<Object, Disposable> mapDisposable;

    public RxPresenter(Application application) {
        super(application);
    }
